        ...
        <div class="container">
            <div class="row">
                <div
                    ...
                    <span>
                        Copyright © {{ date('Y') }} Mahmoud Mohamed Ramadan. All Rights Reserved
                    </span>
                </div>
                <div
                    class="payment-image col-md-6 align-items-center justify-content-md-end justify-content-sm-center d-flex flex-center">
                    <img class="img-fluid" src="{{ asset('assets/images/vendors/bo2q9rPNahDoCCPWd1VNTbWJQdwBYon8tV2t9rKt.png') }}"
                        alt="payment" title="Payment" width="200" />
                </div>
            </div>
        </div>
    </div>
