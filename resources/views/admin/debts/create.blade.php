...
<title>@lang('translate.create_debt') | eCommerce</title>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">@lang('translate.create_debt')
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">@lang('translate.create_debt')
                                    </h4>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control"
                                                                ...
                                                                style="height: 100px;min-height: 100;max-height: 150">{{ old('details') }}</textarea>
                                                            @error('details')
                                                                <span class="text-danger">@lang('translate.'.$message)</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" value="{{ old('remember_date') }}"
