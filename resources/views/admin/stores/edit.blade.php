...
<title>@lang('translate.edit_store') | eCommerce</title>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">@lang('translate.edit_store')
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">@lang('translate.edit_store')
                                    </h4>
                                        ...
                                        <form action="{{ route('stores.update', $store->id) }}" method="POST">
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i
                                                        class="ft-home"></i>@lang('translate.store_data')</h4>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">@lang('translate.store_name')</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="projectinput1">@lang('translate.store_phone')</label>
