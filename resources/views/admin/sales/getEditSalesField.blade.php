...
@for ($i = 0; $i < count($product_name); $i++)
    <div class="sale-fields row" id="{{ $i+1 }}">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" value="{{ $quantity[$i] ?? old('quantity') }}"
                    class="quantity-{{ $i+1 }} form-control" placeholder="@lang('translate.quantity_placeholder')"
                    name="quantity[]" maxlength="4" onkeyup="getTotalPrice({{ $i+1 }})">
