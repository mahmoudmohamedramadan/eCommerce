...
@section('title', __('translate.edit_worker'))
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('translate.edit_worker')
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">@lang('translate.edit_worker')
                                </h4>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="store_id" id="store_id">
                                                            ...
                                                            <option value="{{ $store->id }}" @if ($worker->store_id ==
                                                                $store->id)
                                                                selected
                                                                @endif>
                                                                {{ $store->name }}
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>@lang('translate.worker_permission')</label><select
                                                            ...
                                                            <option value="0" @if ($worker->worker_permission == 0)
                                                                selected
                                                                @endif></option>
                                                            <option value="1" @if ($worker->worker_permission == 1)
                                                                selected
                                                                @endif>@lang('translate.manager')
                                                            </option>
                                                            <option value="2" @if ($worker->worker_permission == 2)
                                                                selected
